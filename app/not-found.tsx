    ...
    return (
        <>
            ...
            <section className="flex min-h-screen w-11/12 flex-col items-center justify-center gap-7 py-14 lg:w-10/12">
                ...
                <span className="font-light text-black dark:text-white md:text-lg">صفحه مورد نظر یافت نشد</span>
                <Link href="/" className="rounded-md bg-primary px-4 py-2.5 text-black dark:text-white">
                    بازگشت به صفحه اصلی
                </Link>
            </section>
        </>
