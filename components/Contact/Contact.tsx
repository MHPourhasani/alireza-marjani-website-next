...
const Contact = () => {
    ...
    const sendEmail = (e:any) => {
        ...
        emailjs.sendForm('service_5qqvqvm', 'template_2u87qwf', form.current, 'p4hqvptU_QHTZdlGj').then(
            (result) => {
    ...
    return (
        <section id="contact" className="flex w-11/12 flex-col items-center justify-between gap-10 py-14 lg:w-10/12 xl:w-8/12">
