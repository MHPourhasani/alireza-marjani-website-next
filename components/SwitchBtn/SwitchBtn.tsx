    ...
    return (
        <div>
            <Switch
                ...
                className="animate__animated animate__slideInRight relative flex h-8 w-16 cursor-pointer items-center rounded-full bg-white shadow-md shadow-gray-300 outline-none transition-colors duration-200 ease-in-out dark:bg-gradient-to-r dark:from-darkGradientOne dark:to-darkGradientTwo dark:shadow dark:shadow-gray-700 sm:h-9 sm:w-[4.5rem] md:h-10 md:w-20"
            >
                <span
                    aria-hidden="true"
